...
namespace vkutil {
	...
	vkutil::DescriptorBuilder& DescriptorBuilder::bind_all_textures(uint32_t binding, VkDescriptorType type, VkShaderStageFlags stageFlags)
	{
	/*	VkDescriptorImageInfo	descriptorImageInfos[TEXTURE_ARRAY_SIZE];
		...
		vkUpdateDescriptorSets(_device, 2, writes,
